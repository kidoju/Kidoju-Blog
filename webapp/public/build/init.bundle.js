...
x.addTest("svgasimg",t.implementation.hasFeature("http://www.w3.org/TR/SVG11/feature#Image","1.1")),/*!
	         ...
	         !*/
x.addAsyncTest(function(){function e(){var e=new Image;e.onerror=function(){s("datauri",!0),x.datauri=new Boolean(!0),x.datauri.over32kb=!1},e.onload=function(){s("datauri",!0),x.datauri=new Boolean(!0),x.datauri.over32kb=1===e.width&&1===e.height};for(var t="R0lGODlhAQABAIAAAAAAAP///ywAAAAAAQABAAACAUwAOw==";t.length<33e3;)t="\r\n"+t;e.src="data:image/gif;base64,"+t}navigator.userAgent.indexOf("MSIE 7.")!==-1&&setTimeout(function(){s("datauri",!1)},10);var t=new Image;t.onerror=function(){s("datauri",!1)},t.onload=function(){1===t.width&&1===t.height?e():s("datauri",!1)},t.src="data:image/gif;base64,R0lGODlhAQABAIAAAAAAAP///ywAAAAAAQABAAACAUwAOw=="});var E=A.testStyles=l;/*!
	         {
	             "name": "Touch Events",
...
x.addTest("flexbox",m("flexBasis","1px",!0)),/*!
	         ...
	         !*/
x.addTest("csstransforms",function(){return navigator.userAgent.indexOf("Android 2.")===-1&&m("transform","scale(1)",!0)});var I=A.prefixed=function(e,t,n){return 0===e.indexOf("@")?O(e):(e.indexOf("-")!==-1&&(e=u(e)),t?h(e,t,n):h(e,"pfx"))},R=I("URL",e,!1);R=R&&e[R],x.addTest("bloburls",R&&"revokeObjectURL"in R&&"createObjectURL"in R),r(),i(y),delete A.addTest,delete A.addAsyncTest;for(var $=0;$<x._q.length;$++)x._q[$]();e.Modernizr=x}(window,document),e.support=window.Modernizr,window.app},n(187))}});
//# sourceMappingURL=init.bundle.js.map?v=0.2.78