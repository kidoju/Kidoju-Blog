...
A.addTest("touchevents",function(){var n;if("ontouchstart"in e||e.DocumentTouch&&t instanceof e.DocumentTouch)n=!0;else{var r=["@media (",T.join("touch-enabled),("),"heartz",")","{#modernizr{top:9px;position:absolute}}"].join("");L(r,function(e){n=9===e.offsetTop})}return n});var j="Moz O ms Webkit",C=E._config.usePrefixes?j.split(" "):[];E._cssomPrefixes=C;var S=function(t){var r,o=T.length,i=e.CSSRule;if("undefined"==typeof i)return n;if(!t)return!1;if(t=t.replace(/^@/,""),r=t.replace(/-/g,"_").toUpperCase()+"_RULE",r in i)return"@"+t;for(var a=0;o>a;a++){var s=T[a],c=s.toUpperCase()+"_"+r;if(c in i)return"@-"+s.toLowerCase()+"-"+t}return!1};E.atRule=S;var k=E._config.usePrefixes?j.toLowerCase().split(" "):[];E._domPrefixes=k;var _={elem:a("modernizr")};A._q.push(function(){delete _.elem});var P={style:_.elem.style};A._q.unshift(function(){delete P.style}),E.testAllProps=v,E.testAllProps=y,/*!
	         ...
	         !*/
A.addTest("csstransforms",function(){return-1===navigator.userAgent.indexOf("Android 2.")&&y("transform","scale(1)",!0)});var U=E.prefixed=function(e,t,n){return 0===e.indexOf("@")?S(e):(-1!==e.indexOf("-")&&(e=i(e)),t?v(e,t,n):v(e,"pfx"))},I=U("URL",e,!1);I=I&&e[I],A.addTest("bloburls",I&&"revokeObjectURL"in I&&"createObjectURL"in I),o(),delete E.addTest,delete E.addAsyncTest;for(var M=0;M<A._q.length;M++)A._q[M]();e.Modernizr=A}(window,document),e.support=window.Modernizr,t.info({message:"browser tested by Modernizr"}),window.app},n(185))}});
//# sourceMappingURL=init.bundle.js.map?v=0.2.22