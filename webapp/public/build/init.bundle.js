/*! Copyright ©2013-2016 Memba® Sarl. All rights reserved. - Version 0.2.77 dated 1/4/2017 */
/*! Copyright ©2013-2016 Memba® Sarl. All rights reserved. - Version 0.2.77 dated 1/4/2017 */
!function(e){function t(o){if(n[o])return n[o].exports;var r=n[o]={exports:{},id:o,loaded:!1};return e[o].call(r.exports,r,r.exports,t),r.loaded=!0,r.exports}var n={};return t.m=e,t.c=n,t.p="https://www.kidoju.com/support/build/",t(0)}({0:function(e,t,n){n(510),n(511),function(){"use strict";var e=window.document,t=window.navigator,n="standalone";if(n in t&&t[n]){var o=e.location,r=/^(a|html)$/i,a="string";e.addEventListener("click",function(e){for(var t=e.target;!r.test(t.nodeName);)t=t.parentNode;var n=t.href;$.type(n)===a&&n.length>1&&n!==o.href&&n.replace(o.protocol+"//"+o.host+o.pathname,"").indexOf("#")&&(!/^[a-z\+\.\-]+:/i.test(n)||0===n.indexOf(o.protocol+"//"+o.host))&&(e.preventDefault(),o.assign(n))},!1)}}(),function(){"use strict";var e=window.app,t=window.location,n=window.document.getElementsByTagName("html")[0].getAttribute("lang"),o=e.uris.webapp.error.replace("{0}",n),r=e.DEBUG&&navigator.userAgent.indexOf("PhantomJS")>=0;if(!r&&t.href.substr(0,o.length)!==o){var a=e.support,i=a.atobbtoa&&a.audio&&(a.audio.mp3||a.audio.ogg)&&a.blobconstructor&&a.bloburls&&a.canvas&&a.canvastext&&a.csstransforms&&a.filereader&&a.flexbox&&a.hashchange&&a.history&&a.localstorage&&a.sessionstorage&&a.svg&&a.inlinesvg&&a.svgasimg&&a.video&&(a.video.h264||a.video.ogg||a.video.webm)&&a.webworkers;i||t.assign(o+"?code=1000")}}()},187:function(e,t){e.exports=function(){throw new Error("define cannot be used indirect")}},510:function(e,t,n){var o,r,a;!function(n,i){"use strict";r=[],o=n,a="function"==typeof o?o.apply(t,r):o,!(void 0!==a&&(e.exports=a))}(function(){"use strict";return function(){function e(e){for(var t=0,n=e,o=/%[sdj]/;"string"==typeof n&&o.test(n);)n=n.replace(o,"{"+t+"}"),t++;return n}var t=window.app=window.app||{},n={join:function(){return Array.prototype.slice.call(arguments).join("/").replace(/([^:])[\/]{2,}/g,"$1/")}};t.DEBUG="true"==="false".toLowerCase(),t.version="0.2.77",t.locales=JSON.parse('["en","fr"]'),t.facebook={clientID:"892459787527630"},t.twitter={account:"kidoju"},t.uris={cdn:{icons:n.join("https://cdn.kidoju.com",e("/images/o_collection/svg/office/%s.svg"))},webapp:{error:n.join("https://www.kidoju.com",e("/support/%s/error")),home:n.join("https://www.kidoju.com",e("/support/")),locale:n.join("https://www.kidoju.com",e("/support/%s")),logger:n.join("https://www.kidoju.com",e("/support/logger")),feed:n.join("https://www.kidoju.com",e("/support/%s/rss.xml")),sitemap:n.join("https://www.kidoju.com",e("/support/%s/sitemap.xml")),pages:n.join("https://www.kidoju.com",e("/support/%s/%s")),posts:n.join("https://www.kidoju.com",e("/support/%s/posts/%s/%s/%s"))}},t.logger=t.logger||{},t.logger.level=parseInt("0",10)||0,t.logger.endPoint=t.uris.webapp.logger}(),window.app},n(187))},511:function(e,t,n){var o,r,a;!function(n,i){"use strict";r=[],o=n,a="function"==typeof o?o.apply(t,r):o,!(void 0!==a&&(e.exports=a))}(function(){"use strict";var e=window.app;return function(e,t,n){function o(e,t){return typeof e===t}function r(){var e,t,n,r,a,i,s;for(var c in b)if(b.hasOwnProperty(c)){if(e=[],t=b[c],t.name&&(e.push(t.name.toLowerCase()),t.options&&t.options.aliases&&t.options.aliases.length))for(n=0;n<t.options.aliases.length;n++)e.push(t.options.aliases[n].toLowerCase());for(r=o(t.fn,"function")?t.fn():t.fn,a=0;a<e.length;a++)i=e[a],s=i.split("."),1===s.length?x[s[0]]=r:(!x[s[0]]||x[s[0]]instanceof Boolean||(x[s[0]]=new Boolean(x[s[0]])),x[s[0]][s[1]]=r),y.push((r?"":"no-")+s.join("-"))}}function a(e){var t=T.className,n=x._config.classPrefix||"";if(C&&(t=t.baseVal),x._config.enableJSClass){var o=new RegExp("(^|\\s)"+n+"no-js(\\s|$)");t=t.replace(o,"$1"+n+"js$2")}x._config.enableClasses&&(t+=" "+n+e.join(" "+n),C?T.className.baseVal=t:T.className=t)}function i(){return"function"!=typeof t.createElement?t.createElement(arguments[0]):C?t.createElementNS.call(t,"http://www.w3.org/2000/svg",arguments[0]):t.createElement.apply(t,arguments)}function s(e,t){if("object"==typeof e)for(var n in e)S(e,n)&&s(n,e[n]);else{e=e.toLowerCase();var o=e.split("."),r=x[o[0]];if(2===o.length&&(r=r[o[1]]),"undefined"!=typeof r)return x;t="function"==typeof t?t():t,1===o.length?x[o[0]]=t:(!x[o[0]]||x[o[0]]instanceof Boolean||(x[o[0]]=new Boolean(x[o[0]])),x[o[0]][o[1]]=t),a([(t&&t!==!1?"":"no-")+o.join("-")]),x._trigger(e,t)}return x}function c(e){return e.replace(/([a-z])-([a-z])/g,function(e,t,n){return t+n.toUpperCase()}).replace(/^-/,"")}function u(){var e=t.body;return e||(e=i(C?"svg":"body"),e.fake=!0),e}function d(e,n,o,r){var a,s,c,d,l="modernizr",f=i("div"),p=u();if(parseInt(o,10))for(;o--;)c=i("div"),c.id=r?r[o]:l+(o+1),f.appendChild(c);return a=i("style"),a.type="text/css",a.id="s"+l,(p.fake?p:f).appendChild(a),p.appendChild(f),a.styleSheet?a.styleSheet.cssText=e:a.appendChild(t.createTextNode(e)),f.id=l,p.fake&&(p.style.background="",p.style.overflow="hidden",d=T.style.overflow,T.style.overflow="hidden",T.appendChild(p)),s=n(f,e),p.fake?(p.parentNode.removeChild(p),T.style.overflow=d,T.offsetHeight):f.parentNode.removeChild(f),!!s}function l(e,t){return!!~(""+e).indexOf(t)}function f(e,t){return function(){return e.apply(t,arguments)}}function p(e,t,n){var r;for(var a in e)if(e[a]in t)return n===!1?e[a]:(r=t[e[a]],o(r,"function")?f(r,n||t):r);return!1}function v(e){return e.replace(/([A-Z])/g,function(e,t){return"-"+t.toLowerCase()}).replace(/^ms-/,"-ms-")}function g(t,o){var r=t.length;if("CSS"in e&&"supports"in e.CSS){for(;r--;)if(e.CSS.supports(v(t[r]),o))return!0;return!1}if("CSSSupportsRule"in e){for(var a=[];r--;)a.push("("+v(t[r])+":"+o+")");return a=a.join(" or "),d("@supports ("+a+") { #modernizr { position: absolute; } }",function(e){return"absolute"===getComputedStyle(e,null).position})}return n}function w(e,t,r,a){function s(){d&&(delete R.style,delete R.modElem)}if(a=!o(a,"undefined")&&a,!o(r,"undefined")){var u=g(e,r);if(!o(u,"undefined"))return u}for(var d,f,p,v,w,h=["modernizr","tspan","samp"];!R.style&&h.length;)d=!0,R.modElem=i(h.shift()),R.style=R.modElem.style;for(p=e.length,f=0;f<p;f++)if(v=e[f],w=R.style[v],l(v,"-")&&(v=c(v)),R.style[v]!==n){if(a||o(r,"undefined"))return s(),"pfx"!==t||v;try{R.style[v]=r}catch(e){}if(R.style[v]!==w)return s(),"pfx"!==t||v}return s(),!1}function h(e,t,n,r,a){var i=e.charAt(0).toUpperCase()+e.slice(1),s=(e+" "+E.join(i+" ")+i).split(" ");return o(t,"string")||o(t,"undefined")?w(s,t,r,a):(s=(e+" "+B.join(i+" ")+i).split(" "),p(s,t,n))}function m(e,t,o){return h(e,n,n,t,o)}var y=[],b=[],A={_version:"3.3.1",_config:{classPrefix:"",enableClasses:!0,enableJSClass:!0,usePrefixes:!0},_q:[],on:function(e,t){var n=this;setTimeout(function(){t(n[e])},0)},addTest:function(e,t,n){b.push({name:e,fn:t,options:n})},addAsyncTest:function(e){b.push({name:null,fn:e})}},x=function(){};x.prototype=A,x=new x,/*!
	         {
...
x.addAsyncTest(function(){function e(){var e=new Image;e.onerror=function(){s("datauri",!0),x.datauri=new Boolean(!0),x.datauri.over32kb=!1},e.onload=function(){s("datauri",!0),x.datauri=new Boolean(!0),x.datauri.over32kb=1===e.width&&1===e.height};for(var t="R0lGODlhAQABAIAAAAAAAP///ywAAAAAAQABAAACAUwAOw==";t.length<33e3;)t="\r\n"+t;e.src="data:image/gif;base64,"+t}navigator.userAgent.indexOf("MSIE 7.")!==-1&&setTimeout(function(){s("datauri",!1)},10);var t=new Image;t.onerror=function(){s("datauri",!1)},t.onload=function(){1===t.width&&1===t.height?e():s("datauri",!1)},t.src="data:image/gif;base64,R0lGODlhAQABAIAAAAAAAP///ywAAAAAAQABAAACAUwAOw=="});var _=A.testStyles=d;/*!
	         ...
	         !*/
x.addTest("touchevents",function(){var n;if("ontouchstart"in e||e.DocumentTouch&&t instanceof e.DocumentTouch)n=!0;else{var o=["@media (",P.join("touch-enabled),("),"heartz",")","{#modernizr{top:9px;position:absolute}}"].join("");_(o,function(e){n=9===e.offsetTop})}return n});var k="Moz O ms Webkit",E=A._config.usePrefixes?k.split(" "):[];A._cssomPrefixes=E;var O=function(t){var o,r=P.length,a=e.CSSRule;if("undefined"==typeof a)return n;if(!t)return!1;if(t=t.replace(/^@/,""),o=t.replace(/-/g,"_").toUpperCase()+"_RULE",o in a)return"@"+t;for(var i=0;i<r;i++){var s=P[i],c=s.toUpperCase()+"_"+o;if(c in a)return"@-"+s.toLowerCase()+"-"+t}return!1};A.atRule=O;var B=A._config.usePrefixes?k.toLowerCase().split(" "):[];A._domPrefixes=B;var L={elem:i("modernizr")};x._q.push(function(){delete L.elem});var R={style:L.elem.style};x._q.unshift(function(){delete R.style}),A.testAllProps=h,A.testAllProps=m,/*!
	         {
	             "name": "Flexbox",
	             "property": "flexbox",
	             "caniuse": "flexbox",
...
x.addTest("flexbox",m("flexBasis","1px",!0)),/*!
	         ...
	         !*/
x.addTest("csstransforms",function(){return navigator.userAgent.indexOf("Android 2.")===-1&&m("transform","scale(1)",!0)});var $=A.prefixed=function(e,t,n){return 0===e.indexOf("@")?O(e):(e.indexOf("-")!==-1&&(e=c(e)),t?h(e,t,n):h(e,"pfx"))},z=$("URL",e,!1);z=z&&e[z],x.addTest("bloburls",z&&"revokeObjectURL"in z&&"createObjectURL"in z),r(),a(y),delete A.addTest,delete A.addAsyncTest;for(var I=0;I<x._q.length;I++)x._q[I]();e.Modernizr=x}(window,document),e.support=window.Modernizr,window.app},n(187))}});
//# sourceMappingURL=init.bundle.js.map?v=0.2.77