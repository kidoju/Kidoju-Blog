...
T.addTest("touchevents",function(){var n;if("ontouchstart"in e||e.DocumentTouch&&t instanceof e.DocumentTouch)n=!0;else{var o=["@media (",P.join("touch-enabled),("),"heartz",")","{#modernizr{top:9px;position:absolute}}"].join("");_(o,function(e){n=9===e.offsetTop})}return n});var k="Moz O ms Webkit",O=b._config.usePrefixes?k.split(" "):[];b._cssomPrefixes=O;var E=function(t){var o,r=P.length,i=e.CSSRule;if("undefined"==typeof i)return n;if(!t)return!1;if(t=t.replace(/^@/,""),o=t.replace(/-/g,"_").toUpperCase()+"_RULE",o in i)return"@"+t;for(var a=0;r>a;a++){var s=P[a],c=s.toUpperCase()+"_"+o;if(c in i)return"@-"+s.toLowerCase()+"-"+t}return!1};b.atRule=E;var L=b._config.usePrefixes?k.toLowerCase().split(" "):[];b._domPrefixes=L;var R={elem:a("modernizr")};T._q.push(function(){delete R.elem});var z={style:R.elem.style};T._q.unshift(function(){delete z.style}),b.testAllProps=w,b.testAllProps=m,/*!
	         ...
	         !*/
T.addTest("csstransforms",function(){return-1===navigator.userAgent.indexOf("Android 2.")&&m("transform","scale(1)",!0)});var $=b.prefixed=function(e,t,n){return 0===e.indexOf("@")?E(e):(-1!==e.indexOf("-")&&(e=c(e)),t?w(e,t,n):w(e,"pfx"))},B=$("URL",e,!1);B=B&&e[B],T.addTest("bloburls",B&&"revokeObjectURL"in B&&"createObjectURL"in B),r(),i(y),delete b.addTest,delete b.addAsyncTest;for(var I=0;I<T._q.length;I++)T._q[I]();e.Modernizr=T}(window,document),e.support=window.Modernizr,window.app},n(185))}});
//# sourceMappingURL=init.bundle.js.map?v=0.2.24