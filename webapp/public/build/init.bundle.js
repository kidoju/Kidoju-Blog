...
/*!
         ...
         !*/
a.addTest("hashchange",function(){return!1!==p("hashchange",e)&&(t.documentMode===n||t.documentMode>7)});var v,g,m=i._config.usePrefixes?" -webkit- -moz- -o- -ms- ".split(" "):["",""];function w(e,t){if("object"==typeof e)for(var n in e)v(e,n)&&w(n,e[n]);else{var o=(e=e.toLowerCase()).split("."),r=a[o[0]];if(2===o.length&&(r=r[o[1]]),void 0!==r)return a;t="function"==typeof t?t():t,1===o.length?a[o[0]]=t:(!a[o[0]]||a[o[0]]instanceof Boolean||(a[o[0]]=new Boolean(a[o[0]])),a[o[0]][o[1]]=t),l([(t&&!1!==t?"":"no-")+o.join("-")]),a._trigger(e,t)}return a}function h(e){return e.replace(/([a-z])-([a-z])/g,function(e,t,n){return t+n.toUpperCase()}).replace(/^-/,"")}function y(e,n,o,r){var i,a,s,l,f="modernizr",p=d("div"),v=function(){var e=t.body;return e||((e=d(c?"svg":"body")).fake=!0),e}();if(parseInt(o,10))for(;o--;)(s=d("div")).id=r?r[o]:f+(o+1),p.appendChild(s);return(i=d("style")).type="text/css",i.id="s"+f,(v.fake?v:p).appendChild(i),v.appendChild(p),i.styleSheet?i.styleSheet.cssText=e:i.appendChild(t.createTextNode(e)),p.id=f,v.fake&&(v.style.background="",v.style.overflow="hidden",l=u.style.overflow,u.style.overflow="hidden",u.appendChild(v)),a=n(p,e),v.fake?(v.parentNode.removeChild(v),u.style.overflow=l,u.offsetHeight):p.parentNode.removeChild(p),!!a}i._prefixes=m,v=s(g={}.hasOwnProperty,"undefined")||s(g.call,"undefined")?function(e,t){return t in e&&s(e.constructor.prototype[t],"undefined")}:function(e,t){return g.call(e,t)},i._l={},i.on=function(e,t){this._l[e]||(this._l[e]=[]),this._l[e].push(t),a.hasOwnProperty(e)&&setTimeout(function(){a._trigger(e,a[e])},0)},i._trigger=function(e,t){if(this._l[e]){var n=this._l[e];setTimeout(function(){var e;for(e=0;e<n.length;e++)(0,n[e])(t)},0),delete this._l[e]}},a._q.push(function(){i.addTest=w}),
/*!
         {
...
/*!
         ...
         !*/
a.addAsyncTest(function(){-1!==navigator.userAgent.indexOf("MSIE 7.")&&setTimeout(function(){w("datauri",!1)},10);var e=new Image;e.onerror=function(){w("datauri",!1)},e.onload=function(){1===e.width&&1===e.height?w("datauri",!0):w("datauri",!1)},e.src="data:image/gif;base64,R0lGODlhAQABAIAAAAAAAP///ywAAAAAAQABAAACAUwAOw=="});var b=i.testStyles=y;
/*!
         {
         "name": "Touch Events",
...
/*!
         ...
         !*/
a.addTest("csstransforms",function(){return-1===navigator.userAgent.indexOf("Android 2.")&&O("transform","scale(1)",!0)});var k=(i.prefixed=function(e,t,n){return 0===e.indexOf("@")?T(e):(-1!==e.indexOf("-")&&(e=h(e)),t?E(e,t,n):E(e,"pfx"))})("URL",e,!1);
/*!
         {
         "name": "Blob URLs",
         "property": "bloburls",
